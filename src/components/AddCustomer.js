...
class AddCustomer extends Component {
    ...
    handleSubmit(event) {
        ...
        CustomerService.addCustomer(data).then(res => {this.props.history.push('/list-customer');});
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="col-lg-3 col-form-label form-control-label"></label>
                            ...
                            <div class="col d-grid gap-2 d-md-flex justify-content-md-end">
							    <button onClick={this.handleSubmit.bind(this)} type="submit" className="btn btn-success float-right">ADD CUSTOMER</button>
                            </div>
                        </div>
                        </form>
                        <div>
